...
flowchart TD
    ...
    D4 --> D6[Merge into agent settings]
...
Shared by all asset kinds: skills, commands, instructions, and MCPs.
...
flowchart TD
    ...
    F --> I[Download tarball, then extract to temp dir]
    G --> I
    H --> I
    I --> J{sub-dir set?}
...
flowchart TD
    ...
    F --> G[available map: name to path]
```
...
flowchart TD
    ...
    F -->|global| G[~/.agent/skills/ per agent\nlock: ~/.local/share/kasetto/kasetto.lock]
